const MeetOurTeam = () => {
  return (
    <div>
		<div className="mt-10">
		<p className="p-2 text-center  md:text-3xl  text-xl  font-bold tracking-wider uppercase">Development team</p>
		</div>
      <section className="py-6 mt-10 dark:bg-gray-700 rounded-lg shadow-lg dark:text-gray-800 w-[90%] mx-auto bg-[#BED7DC]">
