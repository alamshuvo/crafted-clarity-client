  ...
  return (
    <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-[#B3C8CF] dark:bg-gray-50 text-gray-100 dark:text-[#E5DDC5]">
      ...
      <form noValidate="" onSubmit={handleLogin} className="space-y-6">
        ...
        <button className="block w-full p-3 text-center rounded-sm text-gray-900 dark:text-gray-50 bg-[#E5DDC5] hover:bg-[#B3C8CF] dark:bg-violet-600">
          Log in
        </button>
      </form>
      ...
      <div className="flex justify-center space-x-4">
        <button onClick={handleGoogleRegister} aria-label="Log in with Google" className="p-3 rounded-sm">
          <svg
            ...
            viewBox="0 0 32 32"
            className="w-5 h-5 fill-current text-2xl"
          >
      ...
      <p className="text-xl text-center sm:px-6 text-gray-400 dark:text-gray-600">
